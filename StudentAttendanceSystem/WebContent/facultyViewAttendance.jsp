...
<%@page import="com.lnct.student.StudentDao"%>
<%@page import="com.lnct.student.StudentDto"%>
...
<body>
	...
	<div style="width: 50%; margin-left: 25%; margin-top: 5%">
		<h1 style="text-align: center;">Enter Details to View Attendance</h1>
		<form action="facultyViewAttendance.jsp" method="post" name="frm">
		...
		<%
			if (request.getMethod().equalsIgnoreCase("post") || details != null) {
				...
				if (details != null) {
					ArrayList<AttendanceDto> al = new AttendanceDao().getDetailsAttendance(details);
					if (al.size() > 0) {
		%>
			...
			<tr>
				...
				<td><form action="notify.jsp" method="post">
						<input type="hidden" name="details" value=<%=details%>> <input
							...
							type="hidden" name="sub" value="all"> <input
