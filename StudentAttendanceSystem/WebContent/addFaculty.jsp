<%@page import="com.lnct.faculty.FacultyDao"%>
...
<jsp:useBean id="dto" class="com.lnct.faculty.FacultyDto"></jsp:useBean>
...
<body>
	...
	<div style="width: 40%; margin-left: 30%; margin-top: 5%">
		...
		<form action="addEmployee.jsp" method="post">
			<input type="number" name="eid" placeholder="Enter Employee Id"
				class="field" required autofocus="" /> <input type="ename"
				name="ename" placeholder="Enter Faculty name" class="field" required
				required pattern="[A-z|\s]*"
				onchange="this.setCustomValidity(validity.patternMismatch ? 'Please Enter Only Alphabets for Employee Name' : '');" />
			<input type="email" name="email" placeholder="Enter Email"
				class="field" required /> <input type="submit" value="Register" />
		</form>
	</div>
</body>
</html>