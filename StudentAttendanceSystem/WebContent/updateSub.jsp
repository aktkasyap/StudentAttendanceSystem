<%@page import="com.lnct.attendance.AttendanceDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.lnct.attendance.AttendanceDto"%>
...
<script type="text/javascript">
	...
	function check() {
		if (document.getElementById("sub1").value == "null") {
...
<body>
	...
	<div style="width: 40%; margin-left: 30%; margin-top: 5%">
		<h1 style="text-align: center;">Enter Details to Update Subject</h1>
		<form action="updateSub.jsp" method="post">
		...
		<h2 style="text-align: center;">Choose updated Subject</h2>
		<form action="subRedirect.jsp" method="post">
			<div style="width: 50%; margin-left: 20%">
				<select id="sub1" name="sub1" class="field" onchange="unCheck()">
					<option value="null">Subject</option>
								<option value="dsa">DSA</option>
								<option value="automata">Automata</option>
								<option value="os">OS</option>
			...
			<input type="hidden" name="details" value="<%=details%>"> <input
				...
				type="submit" value="Update Subject" id="SubmitBtn"
				onclick="check()">
		</form>
